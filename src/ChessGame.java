...
public class ChessGame
{
	...
	public String movePiece(Position p1, Position p2)
	{
		...
		if (piece1.getChessColor() == Board.swapChessColor(curChessColor))
		{
			return "Error: Please choose a piece with the current color.";
		}

		final String ERROR_MSG = "Error: " + p1 + " to " + p2 + " is an invalid move for " + piece1 + ".";
